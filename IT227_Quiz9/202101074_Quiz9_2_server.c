...
void *client(void *arg) {
     ...
     struct sockaddr_storage clientaddr = params->clientaddr;
     socklen_t clientlen = params->clientlen;
...
int main(int argc, char **argv) {
     ...
     while (1) {
          ...
          pthread_t clientID;
          client_params *params = (client_params *)malloc(sizeof(client_params));
          params->clientaddr = clientaddr;
          params->clientlen = clientlen;
          params->connfd = connfd;
          pthread_create(&clientID, NULL, (void *)client, (void *)params);
     }
     exit(0);
}